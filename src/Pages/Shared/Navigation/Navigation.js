        ...
        <header className="text-gray-600 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center ">
                    ...
                    <a className="mr-5 hover:text-gray-900" href='/'>Explore</a>
                    <a className="mr-5 hover:text-gray-900" href='/'>About</a>
                    {user.email && <a className="mr-5 hover:text-gray-900" href='/'>Dashboard</a>}


                </nav>
                {user && <li className="mr-5 hover:text-gray-900 list-none text-purple-700" href='/'>Hello: {user.displayName}</li>}

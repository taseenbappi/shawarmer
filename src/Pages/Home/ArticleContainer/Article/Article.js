...
const Article = (props) => {
    ...
    console.log(props.article.sub_catagory.catagory)

    return (
        <div className="-my-8 divide-y-2 divide-gray-100">
            <div className="py-8 flex flex-wrap md:flex-nowrap">
                <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                    <span className="font-semibold title-font text-gray-700">CATAGORY</span>
                    <span className="mt-1 text-gray-500 text-sm">{create_time}</span>
                </div>
